...
def generate_launch_description():
    ...
    robot1_group = create_robot_group('1', 'robot1', 'robot1_tf', '-x -0.21344 -y -0.80901 -z 0.0')
    robot2_group = create_robot_group('2', 'robot2', 'robot2_tf', '-x 1.4658 -y 1.7356 -z 0.0')
