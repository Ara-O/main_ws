...
def generate_launch_description():
    ...
    robot1_group = create_robot_group('1', 'robot1', 'robot1_tf', '-x -1.9582 -y 0.27644 -z 0.0')
    robot2_group = create_robot_group('2', 'robot2', 'robot2_tf', '-x 0.44355 -y -2.4055 -z 0.0')
