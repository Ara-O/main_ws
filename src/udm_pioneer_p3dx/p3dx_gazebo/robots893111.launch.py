...
def generate_launch_description():
    ...
    robot1_group = create_robot_group('1', 'robot1', 'robot1_tf', '-x 2.3407 -y 0.24338 -z 0.0')
    robot2_group = create_robot_group('2', 'robot2', 'robot2_tf', '-x -0.21184 -y 5.3271 -z 0.0')
    robot3_group = create_robot_group('3', 'robot3', 'robot3_tf', '-x -1.5396 -y -1.6924 -z 0.0')
    ...
    ld = LaunchDescription([
        ...
        Node(
            ...
            parameters=[{'use_sim_time': True},
                        {'bond_timeout': 0.0},
                        {'autostart': True},
                        {'node_names': ['map_server', 'robot1/amcl', 'robot2/amcl', 'robot3/amcl']}]
        )
    ])
