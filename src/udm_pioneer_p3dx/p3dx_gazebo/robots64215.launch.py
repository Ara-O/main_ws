...
def generate_launch_description():
    ...
    robot1_group = create_robot_group('1', 'robot1', 'robot1_tf', '-x -2.4724 -y -0.83473 -z 0.0')
    robot2_group = create_robot_group('2', 'robot2', 'robot2_tf', '-x 1.4205 -y 0.45816 -z 0.0')
