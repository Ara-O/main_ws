...
def generate_launch_description():
    ...
    robot1_group = create_robot_group('1', 'robot1', 'robot1_tf', '-x -0.29185 -y  -0.16564 -z 0.0')
    robot2_group = create_robot_group('2', 'robot2', 'robot2_tf', '-x 1.4726 -y 1.4678 -z 0.0')
