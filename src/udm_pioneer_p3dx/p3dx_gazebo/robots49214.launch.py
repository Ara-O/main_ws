...
def generate_launch_description():
    ...
    robot1_group = create_robot_group('1', 'robot1', 'robot1_tf', '-x -0.59859 -y 2.7536 -z 0.0')
    robot2_group = create_robot_group('2', 'robot2', 'robot2_tf', '-x 0.41191 -y -1.4858 -z 0.0')
